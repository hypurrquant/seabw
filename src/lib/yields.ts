import type { RiskTag, Tier } from "@/types";
import type { YieldProduct, YieldProductKind } from "@/types/yield-product";
import {
  NAMED_AUDITORS,
  PROTOCOLS,
  whitelistFor,
...
import { isDefiCliAvailable, yieldScan } from "@/lib/defiCli";
