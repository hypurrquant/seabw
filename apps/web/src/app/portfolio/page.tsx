...
import { CHAINS, DEFI_CLI_CHAIN_IDS, chainName } from "@seabw/core";
import { cn, formatPct, formatUsd, truncateAddress } from "@/lib/utils";
import type { PortfolioHealth, Severity } from "@seabw/core";
...
function PortfolioPage() {
  ...
  const fetchHealth = useCallback(async () => {
    ...
    setError(null);
    try {
      const data = await http<{ health: PortfolioHealth | null }>({
        url: `/api/portfolio/health?address=${address}&chainId=${chainId}`,
      });
